...
//         setTimeout(() => {
//           navigate('/products'); // Navigate to the product table after 2 seconds
//         }, 2000);
//       } catch (error) {
