...
public class ProductController {
    ...
    @GetMapping("/search")
    public List<ProductResponse> searchProducts(@RequestParam String productName, @RequestParam(required = false) Integer categoryId, @RequestParam(required = false) Integer brandId) {
